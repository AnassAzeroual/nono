...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 02 mars 2021 à 18:52
...
(3, 24, 'Site Rabat', 38, 'TECH', 12, 'Agent de maintenance', 22, NULL, '0001', 'fatima ZO ', 'f', 109, 'Parka imperméable M (Bleu)', 3, 2, 'M', 'AV', 'A', 4, 2),
...
(21, 24, 'Site Rabat', 39, 'ENTRE', 6, 'Agent d\'entretien', 26, NULL, '9874', 'Ahmed Ziali ', 'h', 111, 'Combinaison  M (Gris)', 3, 2, 'XL', 'AV', 'A', 4, 2);
...
--
-- Index pour la table `web_articles`
--
ALTER TABLE `web_articles`
  ADD PRIMARY KEY (`ref_artweb`);
...
--
-- AUTO_INCREMENT pour la table `web_articles`
--
ALTER TABLE `web_articles`
  MODIFY `ref_artweb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `web_reparationsreformes`
  MODIFY `ref_webrr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
