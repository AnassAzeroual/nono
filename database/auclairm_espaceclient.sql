...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 22 nov. 2020 à 20:43
...
DROP TABLE IF EXISTS `param_liste_metiers`;
CREATE TABLE IF NOT EXISTS `param_liste_metiers` (
  `ref_metier` int(11) NOT NULL AUTO_INCREMENT,
  `intitule_metier` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ref_metier`)
...
(22, 584, 56, 'TRACA', 14, NULL, 22, 'MONDELEZ - MONDELEZ MAROC', 30, 'CASA1/Maintenance', 0, '', 7, '03344', 'Lahcen Ennajar ', '', '', 1, '1 - Linge en forme', 6, '2 - BAS', 15, '1 - pantalon', 1194, 108, 8409, '584-00008393', 'PANT.TECH-BL', 'Pantalon technique', 'M', 'BL', 'Bleu', '', 'étiquette individuelle de tracabilité', '0', '', 1, 0, 0, 0, 'A'),
...
(24, 584, 65, 'TRACA', 14, NULL, 22, 'MONDELEZ - MONDELEZ MAROC', 30, 'CASA1/Maintenance', 1, '', 7, '03344', 'Lahcen Ennajar ', '', '', 1, '1 - Linge en forme', 5, '1 - HAUT', 11, '2 - veste', 1135, 106, 8411, '584-00008395', 'VESTE.TECH-BL', 'Veste technique', 'M', 'BL', 'Bleu', 'Ecusson brodé', 'étiquette individuelle de tracabilité', '0', '', 1, 0, 0, 0, 'A'),
...
(3, 5, 4, 'True', 'True', 'Contrat17000031', '2017-02-01', '2017-02-01', '2017-02-01', '2018-02-01', 'M', 0, 'livraison le mardi à 15H30', 'ACT', 'T'),
...
(48, 57, 558, 'True', 'True', 'Contrat200003', '2020-04-07', '2020-04-07', '2020-04-07', '2020-04-07', 'M', 0, '', 'ACT', 'T'),
...
(52, 61, 563, 'True', 'True', '', '2020-04-28', '2020-04-28', '2020-04-28', '2020-04-28', '', 0, '', 'ACT', 'T'),
...
(484, 1018, 'BL190426', '', '2019-07-15', 8, 431, 'VAL', 'A', NULL, ''),
(517, 985, 'BL190393', '', '2019-07-05', 9, 184, 'VAL', 'A', NULL, ''),
(556, 944, 'BL190354', '', '2019-06-21', 7, 665, 'VAL', 'A', NULL, ''),
(573, 927, 'BL190337', '', '2019-06-07', 8, 523, 'VAL', 'A', NULL, '');
...
DROP TABLE IF EXISTS `web_livraisons_detail`;
CREATE TABLE IF NOT EXISTS `web_livraisons_detail` (
  `ref_wdlivraison` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 4, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 21, NULL, '00000', 'Rachid Ben Aicha ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'XL', 'AV', 'A'),
(2, 4, 66, 24, 'Site Rabat', 38, 'TECH', 12, 'Agent de maintenance', 22, NULL, '0001', 'fatima ZO ', 'f', 111, 'Combinaison  M (Gris)', 3, 2, 'M', 'AV', 'A'),
(3, 3, 66, 24, 'Site Rabat', 38, 'TECH', 12, 'Agent de maintenance', 22, NULL, '0001', 'fatima ZO ', 'f', 109, 'Parka imperméable M (Bleu)', 3, 2, 'M', 'AV', 'A'),
(4, 3, 66, 2, 'site Casa', 34, 'QUAL', 8, 'agent de labo', 2, NULL, '00282', 'Abdelmajid Ahaddar ', 'h', 112, 'Blouse de production longue M (Blanc)', 7, 2, 'L', 'AV', 'A'),
(5, 3, 66, 2, 'site Casa', 34, 'QUAL', 8, 'agent de labo', 1, NULL, '00315', 'Abdeslam Essalhi ', 'h', 112, 'Blouse de production longue M (Blanc)', 7, 2, 'M', 'AV', 'A'),
(6, 3, 66, 24, 'Site Rabat', 38, 'TECH', 12, 'Agent de maintenance', 23, NULL, '0125', 'Simo El Kassimi ', 'h', 111, 'Combinaison  M (Gris)', 3, 99, '4XL', 'AV', 'A'),
(7, 3, 66, 24, 'Site Rabat', 38, 'TECH', 12, 'Agent de maintenance', 23, NULL, '0125', 'Simo El Kassimi ', 'h', 109, 'Parka imperméable M (Bleu)', 3, 99, '5XL', 'AV', 'A'),
(8, 3, 66, 2, 'site Casa', 35, 'COMPTA', 9, 'Agent administratif', 3, NULL, '02822', 'Abderahmane Jazouli ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'XL', 'AV', 'A'),
(9, 3, 66, 2, 'site Casa', 35, 'COMPTA', 9, 'Agent administratif', 4, NULL, '03199', 'Mohamed Nait Sidi Ali ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'L', 'AV', 'A'),
(10, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 5, NULL, '03308', 'Mohamed El Alaoui ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'M', 'AV', 'A'),
(11, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 6, NULL, '03343', 'Aziz Cherifi ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'L', 'AV', 'A'),
(12, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 7, NULL, '03344', 'Lahcen Ennajar ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'L', 'AV', 'A'),
(13, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 8, NULL, '03381', 'Mohamed Ait Ouzeroual ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'S', 'AV', 'A'),
(14, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 9, NULL, '03391', 'Hicham Essaih ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'XL', 'AV', 'A'),
(15, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 11, NULL, '03595', 'Mustapha Amerhoun ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'M', 'AV', 'A'),
(16, 3, 660, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 12, NULL, '03610', 'Mohamed El Hajji ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'L', 'AV', 'A'),
(17, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 13, NULL, '03724', 'Kamal Faouzi ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 99, '5XL', 'AV', 'A'),
(18, 3, 66, 24, 'Site Rabat', 37, 'PROD', 21, 'Agent de production', 14, NULL, '03726', 'Mostafa Kabbali ', 'h', 112, 'Blouse de production longue M (Blanc)', 3, 2, 'M', 'AV', 'A'),
(19, 3, 661, 24, 'Site Rabat', 38, 'TECH', 122, 'Electricien', 24, NULL, '8654', 'Fatima El Amri ', 'f', 111, 'Combinaison  M (Gris)', 3, 2, '', 'AV', 'A'),
(20, 3, 66, 24, 'Site Rabat', 38, 'TECH', 122, 'Electricien', 25, NULL, '96659', 'Khadija Ben moussa ', 'f', 111, 'Combinaison  M (Gris)', 3, 2, 'S', 'AV', 'A'),
(21, 3, 66, 24, 'Site Rabat', 39, 'ENTRE', 6, 'Agent d\'entretien', 26, NULL, '9874', 'Ahmed Ziali ', 'h', 111, 'Combinaison  M (Gris)', 3, 2, 'XL', 'AV', 'A'),
(22, 3, 66, 243, 'lol', 38, NULL, 122, 'Electricien', 100000, NULL, 'matriclue 00888', 'Emmanuel ESTRADE', 'h', 112, 'Blouse de production longue M (Blanc)', NULL, NULL, NULL, 'AV', 'A');
...
DROP TABLE IF EXISTS `web_profilsdroitscontact`;
CREATE TABLE IF NOT EXISTS `web_profilsdroitscontact` (
  `ref_wprofildroits` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `web_receptions` (`ref_wreception`, `refbrc_wreception`, `refacteur_wreception`, `codebrc_wreception`, `dbrc_wreception`, `refsite_wreception`, `site_wreception`, `totpieces_wreception`, `etatbrc_wreception`, `flag_wreception`) VALUES
(11, 1577, 4, 'BRC20000043', '2013-01-20', 5, '', 363, 'ENV', ''),
(561, 1002, 4, 'BRC19000461', '2005-07-19', 5, '', 432, 'ENV', ''),
(600, 950, 4, 'BRC19000412', '2020-10-28', 6, '', 184, 'ENV', ''),
(643, 909, 4, 'BRC19000371', '2020-11-17', 7, '', 931, 'ENV', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=12850 DEFAULT CHARSET=utf8;
...
(647, 1002, 'Blouse col chemisier', 1, ''),
(730, 950, 'Blouse col chemisier', 7, ''),
(2305, 950, 'Blouse kimono', 36, ''),
(2311, 1577, 'Blouse kimono', 169, ''),
(2312, 909, 'Blouse kimono', 285, ''),
(2315, 1002, 'Blouse kimono', 152, ''),
(2606, 1577, 'Blouse MAEL', 5, ''),
(2778, 909, 'Blouse MAEL', 1, ''),
(2849, 1002, 'Blouse SOAN (kimono) couleur', 67, ''),
(2856, 950, 'Blouse SOAN (kimono) couleur', 44, ''),
(2863, 1577, 'Blouse SOAN (kimono) couleur', 25, ''),
(2864, 909, 'Blouse SOAN (kimono) couleur', 36, ''),
(2915, 1002, 'Cagoule passe-montagne', 182, ''),
(2924, 950, 'Cagoule passe-montagne', 53, ''),
(2930, 909, 'Cagoule passe-montagne', 544, ''),
(2940, 1577, 'Cagoule passe-montagne', 157, ''),
(3196, 1002, 'Casquette', 2, ''),
(3198, 1577, 'Casquette', 1, ''),
(3202, 950, 'Casquette', 11, ''),
(4999, 950, 'Gilet SAM', 2, ''),
(8362, 1002, 'Pantalon polaire', 2, ''),
(8364, 950, 'Pantalon polaire', 2, ''),
(8367, 909, 'Pantalon polaire', 7, ''),
(8707, 950, 'Parka imperméable', 15, ''),
(8711, 1577, 'Parka imperméable', 2, ''),
(8713, 909, 'Parka imperméable', 11, ''),
(8714, 1002, 'Parka imperméable', 5, ''),
(12834, 1002, 'Veste polaire', 21, ''),
(12845, 950, 'Veste polaire', 14, ''),
(12847, 1577, 'Veste polaire', 4, ''),
(12849, 909, 'Veste polaire', 47, '');
...
(2, 4, 'ROY AGRI MAROC', 11, 'o', '', 'OUKASSOU', 'Annasssss', 5, 9, 1, '', 'o', 'o', 'A', ''),
(3, 4, 'ROY AGRI MAROC', 11, 'h', '2', 'OUKASSOU', 'Hassan', 6, 20, 3, '', 'o', 'o', 'A', ''),
(4, 4, 'ROY AGRI MAROC', 11, 'hs', '', 'dsfqsdf', 'lola', 6, 20, 1, '', 'o', 'o', 'A', ''),
(5, 4, 'ROY AGRI MAROC', 4, 'EL', '0000', 'LEBON', 'Emmanuel', 7, 0, 3, 'Profil Consultation', 'o', 'o', 'A', ''),
(6, 4, 'ROY AGRI MAROC', 201, 'r', '0', 'LABRADO', 'RUBEN', 7, 0, 3, '', 'o', 'o', 'A', ''),
(7, 552, 'HUI.M6', 275, 'j', '1', 'JORIO', 'ZAKARIA', 7, 0, 1, '', 'o', 'o', 'A', ''),
(8, 563, 'MAGHREB STEEL', 280, 'l', '2', 'Ifrah', 'Badreddine', 7, 0, 1, '', 'o', 'o', 'A', '');
COMMIT;
